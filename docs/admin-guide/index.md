...
This section is for administrators responsible for deploying and maintaining an ollog instance. It covers initial deployment, the admin container, account management, database backup, and internal application logs.
...
- [Application Logs](application-logs.md) — Configure internal logging, inspect live logs, and understand retention and masking
...
| View application logs | Admin container UI at port 8001, Logs page |
