...
- [x] **Phase 41: Multi-Operator UDP Routing** — `app/udp/operator_cache.py` (new), `_handle_datagram` OPERATOR-field routing, `app/main.py` startup wiring, admin router notify_refresh() hooks, docs update, mkdocs rebuild
